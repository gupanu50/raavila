...
const { LOANOFFER } = SCREENS;
const { height, width } = Dimensions.get("screen");
const MainUser = (props: any) => {
        ...
        <View style={styles.container}>
            ...
            <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
                <View style={{
                    ...
                    <Text style={styles.accountNumberText}>Account No.: 74635454654385735</Text>
                    <View style={styles.boxView}>
                        <View style={styles.boxInnerView}>
                            ...
                            <View style={[styles.boxInnerView2, { justifyContent: 'center' }]}>
                                <Text style={styles.text}>Gain in</Text>
                                <Text style={[styles.text, styles.text1]}>18%</Text>
                            </View>
                        </View>
                        <View style={[styles.boxInnerBottomView2, { backgroundColor: COLORS.BLACK }]}>
                            <View style={styles.boxInnerView}>
                    ...
                    <View style={styles.boxView}>
                        <View style={styles.boxInnerView}>
                            <View style={styles.boxInnerView1}>
                                ...
                                <Text style={[styles.text, styles.text1]}>{'\u20B9'} 50,000</Text>
                            </View>
                            <Image source={Images.line2} style={styles.lineImage} />
                            <View style={styles.boxInnerView2}>
                                <TouchableOpacity style={styles.touchInfo}>
                                    <Image source={Images.info} style={styles.infoImage} />
                                </TouchableOpacity>
                                <Text style={styles.text}>Gain in</Text>
                                <Text style={[styles.text, styles.text1, styles.text3]}>10%</Text>
                            </View>
                        </View>
                        <View style={styles.boxInnerBottomView2}>
                            <View style={styles.boxInnerView}>
                                ...
                                <Image source={Images.polygon} style={styles.polygonImage} />
                                <Text style={[styles.text, styles.text2]}> {'\u20B9'} 5,000</Text>
                            </View>
                        </View>
                    </View>
            ...
            <CustomButton label='Check Loan Offers' press={() => navigation.navigate(LOANOFFER)} />
        </View>
    )
}
...
const styles = StyleSheet.create({
    ...
    buttonInnerView: {
        // width: Platform.OS === 'ios' ? adjust(97) : '250%',
        // width: '50%',
        height: adjust(30),
        borderWidth: 0.5,
